...
urlpatterns = [path('', Logueo.as_view(), name='login'),
               ...
               path('password_reset/',password_reset_view.as_view(template_name='registration/password_reset.html',email_template_name='registration/password_reset_email.html',subject_template_name='registration/password_reset_subject.txt'),name='password_reset'),
