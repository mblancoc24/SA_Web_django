...
ALLOWED_HOSTS = ['example.com','localhost','192.168.8.139', '127.0.0.1']
...
from usuario.context_processors import custom_context
TEMPLATES = [
    {
...
EMAIL_HOST_USER = [
    {
        'user': 'victor2722vl@gmail.com',
        'pass': 'ydjbbzuohjwrlpuf'
    },
    {
